...
const PlayerContextProvider = (props) => {
  ...
  const url = 'https://spotify-backend-vvsp.onrender.com';
...
const playWithId = async (id) => {
  ...
  if (id=== item._id) {
    setTrack(item);
      ...
      setPlayStatus(true); // optional: update UI state
...
useEffect(() => {
  if (audioRef.current) {
    audioRef.current.ontimeupdate = () => {
      // ADD THIS CHECK: Only update the style if the seek bar exists
